        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '40px' }}>
            {whyChooseUs.map((item, idx) => (
              ...
              >
                <div style={{ marginBottom: '22px', display: 'flex', justifyContent: 'center', width: '70px', height: '70px', margin: '0 auto 22px', background: 'linear-gradient(135deg, #5CBDAA 0%, #54A1D9 100%)', borderRadius: '12px', alignItems: 'center', justifyContent: 'center', boxShadow: '0 8px 25px rgba(92, 189, 170, 0.25)' }}>
