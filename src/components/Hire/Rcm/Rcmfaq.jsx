...
const FaqRcm = () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer: "Yes — we work inside your EHR, PM, or billing system (NextGen, Athena, eClinicalWorks, etc.). Our team operates within your existing workflows to ensure seamless integration and minimal disruption."
    },
    {
